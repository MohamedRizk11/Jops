    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='', verbose_name='company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loction', django_countries.fields.CountryField(max_length=2)),
                ...
                ('job_nature', models.CharField(choices=[('fulltime', 'fulltime'), ('parttime', 'parttime'), ('remote', 'remote'), ('freelance', 'freelance')], max_length=10)),
                ('experience', models.IntegerField()),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='job.category')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jop_company', to='job.company')),
            ],
        ),
    ]
